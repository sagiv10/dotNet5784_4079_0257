...
public class BlTest
{
    ...
    public static void ReadAllEngineer()
    {
        try
        {
            foreach (var item in s_bl!.Engineer!.ReadAllEngineers())
                Console.WriteLine(item);
        }
        catch (DalNotFoundException problem)
        {
    ...
    public static void CreateNewEngineer()
    {
        try
        {
            ...
            BO.Engineer engToAdd = GenerateEngineerCreate(newId);

            s_bl.Engineer.CreateEngineer(engToAdd);
        }
